#!/bin/bash
# Usage: ./run_profile.sh [fp16|fp32]   (default: fp16)
DTYPE="${1:-fp16}"
...
/usr/local/cuda-11.4/bin/nvprof \
  ...
  python3 /data/frodo/abhishek/GPU_STUDY/gemv_profile.py "$DTYPE"


# /usr/local/cuda-11.4/bin/nvprof \
# --print-gpu-trace  python3 /data/frodo/abhishek/GPU_STUDY/gemv_profile.py "$DTYPE"